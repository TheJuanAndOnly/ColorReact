...
/**
 * Created by Robo on 09/10/2015.
 */
public class ThreesomeActivity extends Activity{

    int rndTxt, rndClr, rndShape, progress = 100, diff = 1;
    double diffPart = 1;
    boolean clrTruth;
    ...
    Button squareBtn, circleBtn, triangleBtn;
    MyCountDownTimer myCountDownTimer;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_threesome);
